 ...
 */
public class InvokerForController {
    private static InvokerForController instance;
    private Queue<ControllerCommand> commands;
    private Timer timer;

    private InvokerForController() {
    ...
    public static InvokerForController getInstance(){
        if(instance == null){
            instance = new InvokerForController();
        }
        return instance;
    }

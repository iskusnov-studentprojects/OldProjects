...
public class MathL1_Java {
    ...
    public static void main(String[] args) throws IOException{
        ...
        try {
            ...
            invA = inversMatrix(Matrix.copy(A));
            determ = determenant(Matrix.copy(A));
            R = countDiscrepancy(A, B, X);
        } catch (Exception ex) {
            Logger.getLogger(MathL1_Java.class.getName()).log(Level.SEVERE, null, ex);
            System.out.print(ex.getMessage());
            return;
        }
        writeToFile(A, X, R, invA, determ, "d:\\output.dat");
    }

...
namespace GraphVisualization
{
    ...
    {
        public WeightedGraph(List<string> vertices, List<string[]> edges) : base(vertices, edges) { }
        ...
        protected override void CreateGraph(List<string> vertices, List<string[]> edges)
        {
            ...
            {
                Edges.Add(new WeightedEdge(FindVertix(i[0]), FindVertix(i[1]), Convert.ToInt32(i[2])));
            }
        }
    }
}

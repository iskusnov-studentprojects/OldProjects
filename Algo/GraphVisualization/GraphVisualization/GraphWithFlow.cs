...
{
    class GraphWithFlow: OrientedGraph
    {
        public GraphWithFlow(List<string> vertices, List<string[]> edges): base(vertices, edges) { }
        protected override void CreateGraph(List<string> vertices, List<string[]> edges)
        {
            ...
            {
                Edges.Add(new EdgeWithFlow(FindVertix(i[0]), FindVertix(i[1]), Convert.ToInt32(i[2]), Convert.ToInt32(i[3])));
            }
        }
    }
}
